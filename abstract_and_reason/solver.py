...
class Solver:
    ...
    def display_test(self, task_id, puzzle_inps_test, puzzle_outs_test=None):
        self.graphics.plot_task(
    ...
    def get_challenge_board(self, challenge_id, challenges, solutions, io: str, type: str, board_idx):
        board = None
